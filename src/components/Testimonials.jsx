  ...
  return (
    <section className="section-wrapper">
      ...
      <div className="content-wrapper content_afterbefore">
        {/* LEFT : TESTIMONIALS */}
        <div className="testimonials" style={{ overflow: "hidden" }}>
          <div
          ...
          >
            ...
            <div
              ...
              style={{ flex: `0 0 ${Math.floor(100 / cardsPerView)}%` }}
            >
              <div className="quote-icon"><svg width="24" height="27" viewBox="0 0 24 27" fill="none" xmlns="http://www.w3.org/2000/svg">
