...
const ServiceForHome = () => {
  ...
  const handleScroll = () => {
    ...
    const firstCard = container.querySelector('.service-card-detailed');
    const cardWidth = (firstCard?.offsetWidth || 350) + 30;

    const currentIndex = Math.round(container.scrollLeft / cardWidth);
    setActivePage(currentIndex);
  };

  const totalDots = serviceCards.length - 2;
    ...
    <section className="services-page">
      <div className="container">
        ...
        <div className="services-carousel-wrapper">
          ...
          <div className="services-cards-container" ref={carouselRef} onScroll={handleScroll}>
